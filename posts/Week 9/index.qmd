...
This report summarises reviews submitted for Video Game products on Amazon from 1999 to 2018 made available by Ni et al. (2019). 
## Number of reviews by year

The below histogram shows the number of video game reviews submitted to Amazon by year. 
...
The below histogram demonstrates that  the large increase in the number of reviews is largely driven by an increase in verified reviews.
...
If you break this data down by verified purchases status you can see that there is a very large number of 5 star reviews for verified purchases compared to unverified purchases.
